...
public class CrimePagerActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_CRIME_ID= "com.bawanj.criminalIntent.crime_id";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setViewPagerCurrentPosition(crimeId); // **
    }
    ...
    private void setViewPagerCurrentPosition(UUID crimeId ){
